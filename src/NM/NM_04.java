...
public class NM_04 {
    ...
    public static void main(String[] args) throws IOException{
        ...
        System.out.println(comb2(n,m,num,chk,0).toString());
    }
    public static StringBuilder comb2(int n, int m ,int[] num, boolean[] chk, int index){
        if(index==m){
            ...
            for(int a=0;a<n;a++){
                if(index>0){
                    if(num[index-1] > (a+1)) continue;
                }
                num[index]=a+1;
                sb.append(comb2(n,m,num,chk,index+1));
            }
            return sb;
        }
    }
